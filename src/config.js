...
export const RUNTIME_GROUPS = [
	{
		...
		fields: [
			...
			{ key: "rustTint", type: "number", label: "Rust tint", value: 0.3, min: 0, max: 1, step: 0.05, hint: "Extra orange tint on top of the rust texture." },
			{ key: "tireDesat", type: "number", label: "Tire desaturate", value: 0.3, min: 0, max: 1, step: 0.05, hint: "Extra desaturation on top of the tire texture." },
		],
	},
	{
		title: "Camera",
