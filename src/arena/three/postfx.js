 ...
 *   → write gl_FragColor.
 *
 * Independent copy for the Arena POC; the DEFAULT_POST_SHADER is intentionally
 * identical to the junkyard's so both demos ship the same default look.
 * ============================================================================
 */
