 ...
 * arena/ui/sidebar.js
 * ----------------------------------------------------------------------------
 * Runtime control sidebar built with Tweakpane from the arena's RUNTIME_GROUPS
 * descriptors. Binds live to a runtime-config object and notifies a callback on
 * any change (camera + floor). Also mounts action buttons (return home, back to
 * setup) and the post-processing shader pad (enable toggle + live-editable
 * fragment shader), matching the junkyard's controls minus the GLB export.
 * ============================================================================
 */
