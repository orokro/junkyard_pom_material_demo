...
export const ITEMS = [
	...
	{ id: "launcher",  label: "Launcher", node: "Launcher", cat: "weapon", mount: "place", outAxis: "x", outSign: -1, barrelAxis: "y", muzzle: [-0.697, 0.695, 0], upBias: 0.4, placeScale: 0.5, weight: 3 },
